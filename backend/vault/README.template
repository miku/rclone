...
We support both classic Intel-based Macs and the current Apple Silicon Macs
...
Download the binary with your browser:

* [rclone.exe](RELEASE_ASSET_WINDOWS_INTEL)
...
* [Intel x86-64](RELEASE_ASSET_LINUX_INTEL)
